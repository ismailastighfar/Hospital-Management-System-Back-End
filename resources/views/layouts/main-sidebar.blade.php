			...
			<div class="main-sidemenu">
				...
				<ul class="side-menu">
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							<li><a class="slide-item" href="{{ url('/' . $page='chart-morris') }}">doctor list</a></li>
							<li><a class="slide-item" href="{{ url('/' . $page='chart-morris') }}">add doctor</a></li>
						</ul>
					</li>
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							<li><a class="slide-item" href="{{ url('/' . $page='chart-morris') }}">Department list</a></li>
							<li><a class="slide-item" href="{{ url('/' . $page='chart-morris') }}">add Department</a></li>
						</ul>
					</li>
					<li class="slide">
						...
						<ul class="slide-menu">
							...
							<li><a class="slide-item" href="{{ url('/' . $page='chart-morris') }}">add Specialty</a></li>
						</ul>
					</li>
					<li class="slide">
						...
						<ul class="slide-menu">
							<li><a class="slide-item" href="{{ url('/' . $page='chart-morris') }}">Medecines list</a></li>
							<li><a class="slide-item" href="{{ url('/' . $page='chart-morris') }}">add Medecine</a></li>
						</ul>
					</li>
					<li class="slide">
