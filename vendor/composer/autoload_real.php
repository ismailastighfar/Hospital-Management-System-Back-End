...
class ComposerAutoloaderInita13806b2316672e4a4da830a7e0a5fc5
{
    ...
    public static function getLoader()
    {
        ...
        if ($useStaticLoader) {
            $includeFiles = Composer\Autoload\ComposerStaticInita13806b2316672e4a4da830a7e0a5fc5::$files;
        } else {
            $includeFiles = require __DIR__ . '/autoload_files.php';
        }
        foreach ($includeFiles as $fileIdentifier => $file) {
            composerRequirea13806b2316672e4a4da830a7e0a5fc5($fileIdentifier, $file);
        }
...
function composerRequirea13806b2316672e4a4da830a7e0a5fc5($fileIdentifier, $file)
{
